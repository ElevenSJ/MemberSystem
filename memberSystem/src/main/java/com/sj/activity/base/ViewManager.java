...
public class ViewManager {
    ...
    private static List<FragmentBase> fragmentList;
    ...
    public void addFragment(int index, FragmentBase fragment) {
    ...
    public FragmentBase getFragment(int index) {
        if (fragmentList != null) {
    ...
    public List<FragmentBase> getAllFragment() {
        if (fragmentList != null) {
            return fragmentList;
        }
        return null;
