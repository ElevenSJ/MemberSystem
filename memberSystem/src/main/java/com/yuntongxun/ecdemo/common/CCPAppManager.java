...
public class CCPAppManager {
    ...
    /**包名*/
    public static String pkgName = "com.lyp.membersystem";
    /**SharedPreferences 存储名字前缀*/
    public static final String PREFIX = "com.lyp.membersystem_";
    ...
    public static void sendRemoveMemberBR(){
    	...
    	getContext().sendBroadcast(new Intent("com.lyp.membersystem.Removemember"));
    }
