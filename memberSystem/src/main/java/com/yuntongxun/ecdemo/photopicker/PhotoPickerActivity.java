 ...
 * @version 5.0
 */
public class PhotoPickerActivity extends ECFragmentActivity implements PhotoAdapter.PhotoClickCallBack ,
...
//        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
    	 LogUtil.d("lyp" ,"onActivityResult: requestCode=" + requestCode
