...
public class ChooseCardFromRuleActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.choose_card_from_rule_layout);
		initView();
		initData();
	}
	...
	public void nextStep(View view) {
		...
		i.putExtra("card_id", cardEnvelopBean.getId());
