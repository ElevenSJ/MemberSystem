...
import com.lyp.membersystem.adapter.GoodsFromRuleAdapter;
...
public class GoodsFromRuleActivity extends BaseActivity implements OnRefreshListener2<ListView> {
	...
	private void initView() {
		...
		mAdapter = new GoodsFromRuleAdapter(goodsList, this);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				intent.setClass(GoodsFromRuleActivity.this, GoodDetailFromRuleActivity.class);
