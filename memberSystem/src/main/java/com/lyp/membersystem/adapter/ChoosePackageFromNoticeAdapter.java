...
public class ChoosePackageFromNoticeAdapter extends BaseAdapter {
	...
	public ChoosePackageFromNoticeAdapter(Context mContext, List<PackageBean> list) {
	...
	public void notifyDataSetChanged() {
		...
		tv.setText("实付款：￥" + 
				(goodPrice + Double.parseDouble(list.get(selectPackage).getPrice()) + cardPrice) * customerNumber);
	}
