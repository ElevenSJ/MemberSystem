...
public class ChooseCustomerAdapter extends BaseAdapter implements SectionIndexer {
	...
	public ChooseCustomerAdapter(Context mContext, List<ContactSortModel> list) {
