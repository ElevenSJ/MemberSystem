    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.order_detail.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("data", orderBean);
                activity.startActivity(i);
            }
        });
        viewHolder.order_no.setText("No." + orderBean.getOrderCode());
        viewHolder.order_date.setText(orderBean.getOrderTime());
...
//		int contactNum = customerList.size();
        int contactNum = orderBean.getCustomerSize();
...
//				}
        ...
        int goodNum = !orderBean.getPreviewImgUrl().isEmpty() ? orderBean.getPreviewImgUrl().size() : 0;
...
//                    if (goodBean.getPicUrls() != null) {
                    ImageManager.loadImage(orderBean.getPreviewImgUrl().get(i), viewHolder.good_iv1);
//                    }
                    break;
                case 1:
...
//                    if (goodBean.getPicUrls() != null) {
                    ImageManager.loadImage(orderBean.getPreviewImgUrl().get(i), viewHolder.good_iv2);
//                    }
                    break;
                case 2:
                    viewHolder.good_iv3.setVisibility(View.VISIBLE);
//                    if (goodBean.getPicUrls() != null) {
                    ImageManager.loadImage(orderBean.getPreviewImgUrl().get(i), viewHolder.good_iv3);
//                    }
                    break;
            }
        }
//		viewHolder.order_name.setText(sb.toString());
        viewHolder.order_name.setText(orderBean.getProductName());
//        DecimalFormat df = new DecimalFormat("0.0");
//        viewHolder.order_price.setText("共计 ￥" + df.format(orderBean.getTotalPrice()));
        viewHolder.order_price.setText("共计 ￥" + orderBean.getTotalPrice());
        String orderState = orderBean.getOrderStatus();
